// Sample project data
const projects = [
    { name: 'PHOTON - Photo Management System', description: 'Developed a Web-based application named Photon for my DBMS course project. The app was inspired by Google Photos. Its frontend was built on bootstrap while the backend used PHP and SQL.', technology: 'Bootsrap, PHP, SQL' },
